...
const dadosPdf = {
    10: {
        ...
        descricao: 'Frio e Climatização · 10ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-10-classe.pdf'
    },
    11: {
        titulo: 'Plano Curricular — 11ª Classe',
        descricao: 'Frio e Climatização · 11ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-11-classe.pdf'
    },
    12: {
        titulo: 'Plano Curricular — 12ª Classe',
        descricao: 'Frio e Climatização · 12ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-12-classe.pdf'
    },
    13: {
        titulo: 'Plano Curricular — 13ª Classe',
        descricao: 'Frio e Climatização · 13ª Classe · Ano Lectivo 2025-2026',
...
const dadosSaidas = [
    {
        id: 1,
        titulo: "Técnico de Refrigeração",
        descricao: "Atua na instalação, manutenção e reparo de sistemas de refrigeração comercial e industrial.",
        competencias: ["Refrigeração", "Manutenção", "Instalação"],
        imagem: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&q=80",
        imagemFallback: "fas fa-snowflake"
    },
    {
        id: 2,
        titulo: "Técnico de Ar Condicionado",
        descricao: "Realiza instalação, manutenção e reparo de sistemas de ar condicionado split, self-contained e central.",
        competencias: ["HVAC", "Climatização", "Manutenção"],
        imagem: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&q=80",
        imagemFallback: "fas fa-wind"
    },
    {
        id: 3,
        titulo: "Instalador de Sistemas HVAC",
        descricao: "Projeta e instala sistemas completos de aquecimento, ventilação e ar condicionado.",
        competencias: ["Projetos", "Instalação", "Dimensionamento"],
        imagem: "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=800&q=80",
        imagemFallback: "fas fa-tools"
    },
    {
        id: 4,
        titulo: "Técnico de Manutenção Industrial",
        descricao: "Realiza manutenção preventiva e corretiva em sistemas de refrigeração e climatização industriais.",
        competencias: ["Manutenção", "Indústria", "Automação"],
        imagem: "https://images.unsplash.com/photo-1581093803998-42f51f5c7e2a?w=800&q=80",
        imagemFallback: "fas fa-industry"
    },
    {
        id: 5,
        titulo: "Projetista de Sistemas Térmicos",
        descricao: "Elabora projetos de sistemas de refrigeração e climatização para edifícios comerciais e industriais.",
        competencias: ["Projetos", "CAD", "Cálculo Térmico"],
        imagem: "https://images.unsplash.com/photo-1581092335871-4c7ff2f3f7f0?w=800&q=80",
        imagemFallback: "fas fa-drafting-compass"
    },
    {
        id: 6,
        titulo: "Consultor de Eficiência Energética",
        descricao: "Analisa e propõe melhorias em sistemas de climatização para redução de consumo energético.",
        competencias: ["Eficiência", "Auditoria", "Sustentabilidade"],
        imagem: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=800&q=80",
        imagemFallback: "fas fa-leaf"
    }
];
