...
const dadosSaidas = [
    {
        ...
        descricao: "Atua na execução e fiscalização de obras civis, garantindo qualidade e cumprimento de prazos.",
        competencias: ["Gestão", "Execução", "Supervisão"],
        imagem: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80",
        imagemFallback: "fas fa-hard-hat"
    },
    {
        id: 2,
        titulo: "Encarregado de Obra",
        descricao: "Coordena equipas de trabalho e supervisiona todas as etapas da construção.",
        competencias: ["Liderança", "Coordenação", "Gestão"],
        imagem: "https://images.unsplash.com/photo-1541976590-713941681591?w=800&q=80",
        imagemFallback: "fas fa-users-cog"
    },
    {
        id: 3,
        titulo: "Orçamentista",
        descricao: "Elabora orçamentos, planilhas de custos e acompanha financeiramente as obras.",
        competencias: ["Cálculo", "Orçamentos", "Controlo"],
        imagem: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&q=80",
        imagemFallback: "fas fa-calculator"
    },
    {
        id: 4,
        titulo: "Fiscal de Obras",
        descricao: "Fiscaliza a execução das obras, garantindo conformidade com projetos e normas.",
        competencias: ["Qualidade", "Fiscalização", "Controlo"],
        imagem: "https://images.unsplash.com/photo-1581094794329-8114a89d3f31?w=800&q=80",
        imagemFallback: "fas fa-clipboard-check"
    },
    {
        id: 5,
        titulo: "Assistente de Projectista",
        descricao: "Auxilia na elaboração de projetos arquitetônicos e estruturais utilizando CAD/BIM.",
        competencias: ["CAD/BIM", "Projectos", "Detalhamento"],
        imagem: "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=800&q=80",
        imagemFallback: "fas fa-drafting-compass"
    },
    {
        id: 6,
        titulo: "Gestor de Manutenção",
        descricao: "Coordena a manutenção predial e industrial, planeando intervenções e reparos.",
        competencias: ["Manutenção", "Gestão", "Planeamento"],
