...
const dadosPdf = {
    10: {
        ...
        descricao: 'Desenhador Projectista · 10ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-10-classe.pdf'
    },
    11: {
        titulo: 'Plano Curricular — 11ª Classe',
        descricao: 'Desenhador Projectista · 11ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-11-classe.pdf'
    },
    12: {
        titulo: 'Plano Curricular — 12ª Classe',
        descricao: 'Desenhador Projectista · 12ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-12-classe.pdf'
    },
    13: {
        titulo: 'Plano Curricular — 13ª Classe',
        descricao: 'Desenhador Projectista · 13ª Classe · Ano Lectivo 2025-2026',
...
const dadosSaidas = [
    {
        id: 1,
        titulo: "Desenhador Projectista",
        descricao: "Elabora projetos arquitetônicos e estruturais utilizando software CAD/BIM.",
        competencias: ["CAD", "BIM", "Projetos"],
    ...
    },
    {
        ...
        descricao: "Cria modelos digitais de construção com informações detalhadas para todo o ciclo de vida do projeto.",
        competencias: ["BIM", "Revit", "Coordenação"],
        imagem: "https://images.unsplash.com/photo-1581092335871-4c7ff2f3f7f0?w=800&q=80",
        imagemFallback: "fas fa-cube"
    },
    {
        id: 3,
        titulo: "Técnico de CAD",
        descricao: "Desenvolve desenhos técnicos detalhados para projetos de engenharia e arquitetura.",
        competencias: ["AutoCAD", "Detalhamento", "Desenho Técnico"],
        imagem: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&q=80",
        imagemFallback: "fas fa-pencil-ruler"
    },
    {
        id: 4,
        titulo: "Projetista de Estruturas",
        descricao: "Elabora projetos estruturais detalhados para edificações de diversos portes.",
        competencias: ["Estruturas", "Cálculo", "Detalhamento"],
        imagem: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80",
        imagemFallback: "fas fa-draw-polygon"
    },
    {
        id: 5,
        titulo: "Projetista de Instalações",
        descricao: "Desenvolve projetos de instalações hidráulicas, elétricas e de climatização.",
        competencias: ["Hidráulica", "Elétrica", "HVAC"],
        imagem: "https://images.unsplash.com/photo-1581093803998-42f51f5c7e2a?w=800&q=80",
        imagemFallback: "fas fa-faucet"
    },
    {
        id: 6,
        titulo: "Visualizador Arquitetônico",
        descricao: "Cria renderizações e visualizações 3D realistas de projetos arquitetônicos.",
        competencias: ["3D", "Renderização", "SketchUp"],
        imagem: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80",
        imagemFallback: "fas fa-camera"
    }
];
