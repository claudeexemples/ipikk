...
const dadosPdf = {
    10: {
        ...
        descricao: 'Tecnologia de Móveis · 10ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-10-classe.pdf'
    },
    11: {
        titulo: 'Plano Curricular — 11ª Classe',
        descricao: 'Tecnologia de Móveis · 11ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-11-classe.pdf'
    },
    12: {
        titulo: 'Plano Curricular — 12ª Classe',
        descricao: 'Tecnologia de Móveis · 12ª Classe · Ano Lectivo 2025-2026',
        url: 'documentos/plano-curricular-12-classe.pdf'
    },
    13: {
        titulo: 'Plano Curricular — 13ª Classe',
        descricao: 'Tecnologia de Móveis · 13ª Classe · Ano Lectivo 2025-2026',
...
const dadosSaidas = [
    {
        id: 1,
        titulo: "Marceneiro",
        descricao: "Constrói e repara móveis e objetos de madeira, utilizando técnicas tradicionais e modernas.",
        competencias: ["Marcenaria", "Entalhe", "Acabamento"],
        imagem: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80",
        imagemFallback: "fas fa-hammer"
    },
    {
        id: 2,
        titulo: "Designer de Móveis",
        descricao: "Cria projetos e desenhos técnicos de móveis, considerando estética, funcionalidade e ergonomia.",
        competencias: ["Design", "SketchUp", "Ergonomia"],
    ...
    },
    {
        ...
        descricao: "Opera máquinas industriais para corte, fresagem e acabamento de peças de madeira.",
        competencias: ["CNC", "Serras", "Fresadoras"],
        imagem: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&q=80",
        imagemFallback: "fas fa-industry"
    },
    {
        id: 4,
        titulo: "Restaurador de Móveis",
        descricao: "Restaura e conserva móveis antigos, preservando técnicas e estilos originais.",
        competencias: ["Restauro", "Conservação", "Acabamento"],
        imagem: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80",
        imagemFallback: "fas fa-brush"
    },
    {
        id: 5,
        titulo: "Técnico em Acabamentos",
        descricao: "Aplica técnicas de pintura, verniz e outros acabamentos em móveis e peças de madeira.",
        competencias: ["Pintura", "Verniz", "Lixamento"],
        imagem: "https://images.unsplash.com/photo-1581092335871-4c7ff2f3f7f0?w=800&q=80",
        imagemFallback: "fas fa-fill-drip"
    },
    {
        id: 6,
        titulo: "Gestor de Produção Moveleira",
        descricao: "Coordena equipas e processos de produção na indústria moveleira, garantindo qualidade e prazos.",
        competencias: ["Gestão", "Produção", "Qualidade"],
...
function corrigirLinks() {
    const mapeamentoLinks = {
        ...
        'ipikk-tecnologia-moveis-curso.html': 'tecnologia-moveis-curso.html',
